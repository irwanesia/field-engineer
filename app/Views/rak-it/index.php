                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button type="button" class="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#edit<?= $row['id_rakit'] ?>"><i class="bi bi-pencil-square"></i></button>
                                            <button type="submit" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#delete<?= $row['id_rakit'] ?>"><i class="bi bi-trash"></i></button>
                                        </td>
                                    </tr>
                                    <?php endforeach ?>
                                </tbody>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <section class="section">
                        ...
                        <div class="card-body">
                        <form action="<?= base_url('/rak-it/add') ?>" method="post">
                        <?= csrf_field() ?>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <h6 for="distro">Distro</h6>
                                        <input type="text" class="form-control" name="distro" id="distro" required>
                                    </div>                                
                                    <div class="form-group">
...
<?php foreach($rakit as $row) : ?>
<div class="me-1 mb-1 d-inline-block">
    <div class="modal fade text-left w-100" id="edit<?= $row['id_rakit'] ?>"" tabindex="-1" role="dialog" aria-labelledby="myModalLabel16" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
            ...
            <div class="modal-body">
                <section class="section">
                    <div class="card">
                        <div class="card-body">
                            <form action="<?= base_url('/rak-it/edit/'. $row['id_rakit']) ?>" method="post">
                                <?= csrf_field() ?>
                                    <input type="hidden" name="id_rakit" value="<?= $row['id_rakit'] ?>">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <h6 for="distro">Distro</h6>
...
<?php foreach($rakit as $row) : ?>
<div class="me-1 mb-1 d-inline-block">
    <div class="modal fade text-left w-100" id="delete<?= $row['id_rakit'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel16" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-md" role="document">
            ...
            <div class="modal-body">
                <form action="<?= base_url('/rak-it/delete/'. $row['id_rakit']) ?>" method="post">
                <?= csrf_field() ?>
